...
import hu.frontrider.blockfactory.block.templates.TemplatedStairs;
...
public class StairsInitializer implements BlockTemplateInitializer {
    @Override
    public Block initialize(BlockTemplate template, Identifier identifier) {
        Block block = Registry.register(Registry.BLOCK, identifier, new TemplatedStairs(template));
        if (template.hasItem()) {
