...
import hu.frontrider.blockfactory.block.templates.TemplatedSlab;
...
public class SlabInitializer implements BlockTemplateInitializer {
    @Override
    public Block initialize(BlockTemplate template, Identifier identifier) {
        Block block = Registry.register(Registry.BLOCK, identifier, new TemplatedSlab(template));
